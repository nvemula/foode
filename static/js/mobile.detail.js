...
$('#plusitems').show();
	...
	$('.additem').live("click",function() {
        ...
        var template='<hr"/"><input type="text" class="input-medium field listitems" name="listitem'+aid +'z'+ j +'" id="menuitemrem' + j +'" value="Item""/"><a href="#'+aid+'" class="remove removeitems" style="text-decoration:none;text-align:center;" id="rem' + j +'">&nbsp&nbsp<i class="icon-remove icon-black"></i></a><br>';
